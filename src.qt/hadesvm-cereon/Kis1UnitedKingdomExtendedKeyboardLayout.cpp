    ...
    :   _kis1ScanCodesForNativeScanCodes()
{
    ...
    _kis1ScanCodesForNativeScanCodes[62] = 99;  //  RShift
    _kis1ScanCodesForNativeScanCodes[95] = 100; //  F11
    _kis1ScanCodesForNativeScanCodes[96] = 101; //  F12
    _kis1ScanCodesForNativeScanCodes[133] = 102;//  LWin
    //_kis1ScanCodesForNativeScanCodes[?] = 103;// RWin
    _kis1ScanCodesForNativeScanCodes[135] = 104;//  Menu
    ...
    _kis1ScanCodesForNativeScanCodes[54] = 99;  //  RShift
    _kis1ScanCodesForNativeScanCodes[87] = 100; //  F11
    _kis1ScanCodesForNativeScanCodes[88] = 101; //  F12
    _kis1ScanCodesForNativeScanCodes[57435] = 102;//  LWin
    //_kis1ScanCodesForNativeScanCodes[?] = 103;// RWin
    _kis1ScanCodesForNativeScanCodes[57437] = 104;//  Menu
#else
